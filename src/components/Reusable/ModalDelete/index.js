...
const ModalDelete = (props) => {
  const { data, handleModal, show, isListItem, handleRefresh, refresh } = props;
          ...
          <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div class="sm:flex sm:items-start">
                <div class="mt-3 flex flex-col gap-[50px] items-center text-center sm:ml-4 sm:mt-0 sm:text-center">
                  ...
                  <h3
                    class="text-lg font-medium  text-[#111]"
                    id="modal-title"
            ...
            <div class="py-3 flex flex-row-reverse px-6 gap-[20px] items-center justify-center">
              <button
                data-cy="modal-delete-confirm-button"
                type="button"
                class="inline-flex w-[150px] justify-center rounded-[45px] bg-[#ED4C5C] px-[14px] py-[13px] text-lg font-semibold text-white  hover:bg-red-500"
              ...
              <button
                ...
                type="button"
                class="inline-flex w-[150px] justify-center rounded-[45px] bg-[#F4F4F4] text-lg text-[#4A4A4A] px-[14px] py-[13px] font-semibold shadow-sm "
